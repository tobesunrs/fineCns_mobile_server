...
@Configuration
@MapperScan(value="com.ins.mapper", sqlSessionFactoryRef="sqlSessionFactory")
...
//        factoryBean.setMapperLocations(applicationContext.getResources("classpath:query/**/*_mapper.xml"));
//        return factoryBean.getObject();
    }
